...
#/usr/bin/g++ ./src/*.cpp -o ./bin/FluidX3D -std=c++17 -pthread -I./src/OpenCL/include -framework OpenCL # compile on macOS (without X11)
#/usr/bin/g++ ./src/*.cpp -o ./bin/FluidX3D -std=c++17 -pthread -I./src/OpenCL/include -I/opt/X11/include -L/opt/X11/lib -lX11  -framework OpenCL # compile on macOS with X11
